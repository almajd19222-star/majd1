                                        ...
                                        <table  id="" class="example display cell-border compact row-border hover order-column stripe text-center" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>متوقف عند الجهة المنقول منها؟</th>  
                                                    <th>رقم الكتاب</th>                
                                                    <th>تاريخ الكتاب</th>                           
                                                    <th>ملاحظات</th>
                                ...
                                while($row = mysqli_fetch_assoc($result)) {
                                  echo'<tr><td class=""> <a href="m_edit_move.php?id='.$row["id"].'"><i style="font-size: 2.5rem" class="zwicon-edit-circle"></i></a></td>';                                                              
                                  echo '<td class="'.$td_class.'">'.$row["masdar_num"].'</td>'.
                                  '<td class="'.$td_class.'">'.$row["fake_name"].'</td>'.
                                  '<td class="'.$td_class.'">'.$row["moved_from"].'</td>'. 
                                  '<td class="'.$td_class.'">'.$row["moved_to"].'</td>'.
                                  '<td class="'.$td_class.'">'.$row["move_date"].'</td>'.
                                  '<td class="'.$td_class.'">'.$row["move_done_date"].'</td>'.
                                  '<td class="'.$td_class.'">'.$row["moved_from_active"].'</td>'.
