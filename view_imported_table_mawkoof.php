...
$details_type = 'وارد';
$sql_public="SELECT distinct(ketab_num),ketab_date  from temp_mawkoof_data ORDER BY ketab_num ASC";
                ...
                <td colspan="" style="border:none;">
                    <div id="container">
                        ...
                        <div id="center" style="font-family: 'Hacen Liner Screen'; color: black; width:300px">
                            <a>فهرس البريد الإلكتروني الوارد (أضابير الموقوفين)</a>
           ...
           <!--  </thead> -->
            <tbody>
                ...
                while($row_public = mysqli_fetch_assoc($sql_public_result)) { 
                    ...
                    //count mawkoof
                    $sql_mawkoof_count="SELECT count(id) as count_mawkoof from `temp_mawkoof_data` WHERE  ketab_num=".$row_public['ketab_num']." 
