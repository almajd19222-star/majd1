...
$details_type = 'صادر';
    ...
    $sql_public="SELECT * from temp_reports_info ORDER BY ketab_num ASC ";
           ...
           <!--  </thead> -->
            <tbody>
                ...
                while($row_public = mysqli_fetch_assoc($sql_public_result)) { 
                    $feech_count=0;
                    $mawkoof_count=0;   
                    $sql_dewan="SELECT d_attach, dewan_num from temp_dewan WHERE ketab_num = ".$row_public['ketab_num']." AND ketab_date = '".$row_public['ketab_date']."' AND  jeha = '$jeha_profile' AND details_type='$details_type' ORDER BY dewan_num ASC"; 
                    ...
                    ?>
                        ...
                        <td>
                            <?php
                            $sql_study="SELECT name, fname, lname FROM temp_study WHERE ketab_num = ".$row_public['ketab_num']." AND ketab_date = '".$row_public['ketab_date']."' AND  jeha = '$jeha_profile' AND details_type='$details_type' ORDER BY study_date ASC";
                        ...
                        <td>
                            ...
                            if( strpos($jeha_profile,'828') !== false || strpos($jeha_profile,'626') !== false ){
                                $sql="SELECT place_name FROM temp_studies_all_828 WHERE ketab_num = ".$row_public['ketab_num']." AND ketab_date = '".$row_public['ketab_date']."' AND  jeha = '$jeha_profile' AND details_type='$details_type' ORDER BY place_name  ASC";
                            }else{
                                $sql="SELECT place_name FROM temp_studies_all WHERE ketab_num = ".$row_public['ketab_num']." AND ketab_date = '".$row_public['ketab_date']."' AND  jeha = '$jeha_profile' AND details_type='$details_type' ORDER BY place_name  ASC";
                            }
                        ...
                        <td>
                            <?php
                            $sql="SELECT id FROM temp_feech_info WHERE ketab_num = ".$row_public['ketab_num']." AND ketab_date = '".$row_public['ketab_date']."' AND  jeha = '$jeha_profile' AND details_type='$details_type' ORDER BY id  ASC";
                            $sql_result = mysqli_query($conn, $sql);
                        ...
                        <td>
                            <?php
                            $sql="SELECT id FROM temp_mawkoof_data WHERE ketab_num = ".$row_public['ketab_num']." AND ketab_date = '".$row_public['ketab_date']."' AND  jeha = '$jeha_profile' AND details_type='$details_type' ORDER BY id  ASC";
                            $sql_result = mysqli_query($conn, $sql);
                            if (mysqli_num_rows($sql_result) > 0) {
                                $c=1;
                                while ($row = mysqli_fetch_assoc($sql_result)) {
